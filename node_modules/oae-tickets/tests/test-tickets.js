        ...
        describe('#createTicket()', function() {
            ...
            describe('verify parameters', function() {
                ...
                describe('publication', function() {
                    ...
                    /**
                     * Test that verifies that a valid institution has been entered
                     */
                    it('verify that a valid institution has been entered', function(callback) {

                        // Create a new content item
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            assert.ok(!err);

                            // Creating a ticket with an invalid or missing 'institution'
                            var publication = {
                                'displayName': 'Some displayName',
                    ...
                    /**
                     * Test that verifies that a valid department has been entered
                     */
                    it('verify that a valid department has been entered', function(callback) {

                        // Create a new content item
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            assert.ok(!err);

                            // Creating a ticket with an invalid or missing 'department'
                            var publication = {
                                'displayName': 'Some displayName',
                                'authors': ['author A', 'author B'],
                    ...
                    it('verify that a valid journalName has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            var publication = {
                                ...
                                'authors': ['author A', 'author B'],
                                'institution': 'Some institution',
                                'department': 'Department of madness',
                                'journalName': null
                            };
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);
