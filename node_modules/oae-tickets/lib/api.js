...
var createTicket = module.exports.createTicket = function(ctx, contentId, sourceIds, publication, callback) {
    ...
    ContentDAO.Content.getContent(contentId, function(err, content) {
        ...
        if (publication) {
            ...
            validator.check(publication.institution, {'code': 400, 'msg': 'Missing or invalid institution'}).isShortString();
            validator.check(publication.department, {'code': 400, 'msg': 'Missing or invalid department'}).isShortString();
