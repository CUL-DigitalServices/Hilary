...
module.exports = function(config, callback) {
    _ensureSchema(function(err) {
        ...
        Tickets.initializeTickets(callback);
    });
};
...
var _ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        'ArticleTickets': 'CREATE COLUMNFAMILY ArticleTickets (ticketId text PRIMARY KEY, publicationId text, createdBy text, created text, lastModified text, status text);'
    }, callback);
};
